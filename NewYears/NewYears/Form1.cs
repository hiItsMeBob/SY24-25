using System; using System.Windows.Forms; namespace NewYears{public partial class Form1 : Form{public Form1(){InitializeComponent();}
        int[] total = new int[8];
        ...
        private void button1_Click(object sender, EventArgs e) { Line1.Text = "0";Bit1.Text = "0";Bit2.Text = "0";Bit3.Text = "0";Bit4.Text = "0";Bit5.Text = "0";Bit6.Text = "0";Bit7.Text = "0";Bit8.Text = "0";total[0] = 0; }private void ResetBtn2_Click(object sender, EventArgs e) {Line2.Text = "0";Bit9.Text = "0";Bit10.Text = "0";Bit11.Text = "0";Bit12.Text = "0";Bit13.Text = "0";Bit14.Text = "0";Bit15.Text = "0";Bit16.Text = "0";total[1] = 0;}
        private void ResetBtn3_Click(object sender, EventArgs e){Line3.Text = "0";Bit17.Text = "0"; Bit18.Text = "0";  Bit19.Text = "0"; Bit20.Text = "0"; Bit21.Text = "0"; Bit22.Text = "0"; Bit23.Text = "0"; Bit24.Text = "0";total[2] = 0;}
        private void ResetAllBtn_Click(object sender, EventArgs e) { Line1.Text = "0"; Bit1.Text = "0";Bit2.Text = "0"; Bit3.Text = "0";  Bit4.Text = "0"; Bit5.Text = "0"; Bit6.Text = "0";  Bit7.Text = "0"; Bit8.Text = "0"; total[0] = 0;Line2.Text = "0"; Bit9.Text = "0"; Bit10.Text = "0";Bit11.Text = "0";Bit12.Text = "0"; Bit13.Text = "0"; Bit14.Text = "0"; 
            Bit15.Text = "0"; Bit16.Text = "0"; total[1] = 0;   Line3.Text = "0"; Bit17.Text = "0"; Bit18.Text = "0"; Bit19.Text = "0"; Bit20.Text = "0"; Bit21.Text = "0"; Bit22.Text = "0"; Bit23.Text = "0"; Bit24.Text = "0"; total[2] = 0; }
        private void ConfigBTN_Click(object sender, EventArgs e) { Line1.Text = total[0].ToString();Line2.Text= total[1].ToString();  Line3.Text= total[2].ToString(); label5.Text=total[3].ToString(); }
        private void Bit24_MouseDown(object sender, MouseEventArgs e) { if (((TextBox)sender).Text == "1") { ((TextBox)sender).Text = "0"; } else{ ((TextBox)sender).Text = "1";} }delegate void Real();}}
//total[3]+=1;